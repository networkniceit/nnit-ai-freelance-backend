...
callBtn.addEventListener('click',async()=>{const p=pathInput.value.trim()||'/api/advancedUserPreferences';out.textContent='...';const r=await call(p);out.textContent=typeof r==='string'?r:JSON.stringify(r,null,2)});
