// routes/advancedSurveyExport.js
// Advanced Feature: Advanced Survey Export (step 81)
...
// POST /api/survey-export/advanced
router.post('/', authenticateJWT, async (req, res) => {
    try {
        ...
        res.json({ success: true, exportId, message: 'Advanced survey export started.' });
    } catch (error) {
        res.status(500).json({ success: false, message: 'Export failed.', error: error.message });
    }
});

// GET /api/survey-export/advanced/status
