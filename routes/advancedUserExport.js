// routes/advancedUserExport.js
// Advanced Feature: Advanced User Export (step 61)
...
// POST /api/users-export/advanced
router.post('/', authenticateJWT, async (req, res) => {
    try {
        ...
        res.json({ success: true, exportId, message: 'Advanced user export started.' });
    } catch (error) {
        res.status(500).json({ success: false, message: 'Export failed.', error: error.message });
    }
});

// GET /api/users-export/advanced/status
