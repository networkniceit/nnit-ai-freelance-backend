// routes/advancedInvoiceExport.js
// Advanced Feature: Advanced Invoice Export (step 63)
...
// POST /api/invoices-export/advanced
router.post('/', authenticateJWT, async (req, res) => {
    try {
        ...
        res.json({ success: true, exportId, message: 'Advanced invoice export started.' });
    } catch (error) {
        res.status(500).json({ success: false, message: 'Export failed.', error: error.message });
    }
});

// GET /api/invoices-export/advanced/status
