// routes/advancedFormExport.js
// Advanced Feature: Advanced Form Export (step 91)
...
router.post('/', authenticateJWT, async (req, res) => {
    try {
        ...
        res.json({ success: true, exportId, message: 'Advanced form export started.' });
    } catch (error) {
        res.status(500).json({ success: false, message: 'Export failed.', error: error.message });
    }
});

// GET /api/form-export/advanced/status
