// routes/advancedWidgetExport.js
// Advanced Feature: Advanced Widget Export (step 100)
...
// POST /api/widget-export/advanced
router.post('/', authenticateJWT, async (req, res) => {
    try {
        ...
        res.json({ success: true, exportId, message: 'Advanced widget export started.' });
    } catch (error) {
        res.status(500).json({ success: false, message: 'Export failed.', error: error.message });
    }
});

// GET /api/widget-export/advanced/status
