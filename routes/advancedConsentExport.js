// routes/advancedConsentExport.js
// Advanced Feature: Advanced Consent Export (step 53)
...
// POST /api/consent-export/advanced
router.post('/', authenticateJWT, async (req, res) => {
    try {
        ...
        res.json({ success: true, exportId, message: 'Advanced consent export started.' });
    } catch (error) {
        res.status(500).json({ success: false, message: 'Export failed.', error: error.message });
    }
});

// GET /api/consent-export/advanced/status
