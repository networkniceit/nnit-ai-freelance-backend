// routes/advancedPaymentExport.js
// Advanced Feature: Advanced Payment Export (step 65)
...
// POST /api/payments-export/advanced
router.post('/', authenticateJWT, async (req, res) => {
    try {
        ...
        res.json({ success: true, exportId, message: 'Advanced payment export started.' });
    } catch (error) {
        res.status(500).json({ success: false, message: 'Export failed.', error: error.message });
    }
});

// GET /api/payments-export/advanced/status
