// routes/advancedReviewExport.js
// Advanced Feature: Advanced Review Export (step 72)
...
// POST /api/review-export/advanced
router.post('/', authenticateJWT, async (req, res) => {
    try {
        ...
        res.json({ success: true, exportId, message: 'Advanced review export started.' });
    } catch (error) {
        res.status(500).json({ success: false, message: 'Export failed.', error: error.message });
    }
});

// GET /api/review-export/advanced/status
