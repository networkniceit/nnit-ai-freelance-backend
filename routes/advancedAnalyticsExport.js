// routes/advancedAnalyticsExport.js
// Advanced Feature: Advanced Analytics Export (step 57)
...
// POST /api/analytics-export/advanced
router.post('/', authenticateJWT, async (req, res) => {
    try {
        ...
        res.json({ success: true, exportId, message: 'Advanced analytics export started.' });
    } catch (error) {
        res.status(500).json({ success: false, message: 'Export failed.', error: error.message });
    }
});

// GET /api/analytics-export/advanced/status
