// routes/advancedAuditExport.js
// Advanced Feature: Advanced Audit Export (step 51)
...
// POST /api/audit-export/advanced
router.post('/', authenticateJWT, async (req, res) => {
    try {
        ...
        res.json({ success: true, exportId, message: 'Advanced audit export started.' });
    } catch (error) {
        res.status(500).json({ success: false, message: 'Export failed.', error: error.message });
    }
});

// GET /api/audit-export/advanced/status
