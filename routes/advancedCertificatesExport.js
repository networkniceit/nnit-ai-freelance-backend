// routes/advancedCertificatesExport.js
// Advanced Feature: Advanced Certificates Export (step 59)
...
// POST /api/certificates-export/advanced
router.post('/', authenticateJWT, async (req, res) => {
    try {
        ...
        res.json({ success: true, exportId, message: 'Advanced certificates export started.' });
    } catch (error) {
        res.status(500).json({ success: false, message: 'Export failed.', error: error.message });
    }
});

// GET /api/certificates-export/advanced/status
