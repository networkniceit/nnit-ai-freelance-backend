// routes/advancedJobsExport.js
// Advanced Feature: Advanced Jobs Export (step 58)
...
router.post('/', authenticateJWT, async (req, res) => {
    try {
        ...
        res.json({ success: true, exportId, message: 'Advanced jobs export started.' });
    } catch (error) {
        res.status(500).json({ success: false, message: 'Export failed.', error: error.message });
    }
});

// GET /api/jobs-export/advanced/status
